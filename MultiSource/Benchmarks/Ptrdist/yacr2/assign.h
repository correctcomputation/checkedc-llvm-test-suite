...
extern _Array_ptr<_Array_ptr<ulong>> costMatrix;
extern _Array_ptr<ulong> tracksNoHCV;
extern _Array_ptr<ulong> tracksNotPref;
...
extern _Array_ptr<ulong> tracksAssign;
